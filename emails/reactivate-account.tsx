...
export const DifrisulChangeEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Reative Sua Conta</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Reative Sua Conta</Heading>
          <Text style={text}>Olá!</Text>
          <Text style={text}>
            Recebemos uma solicitação para reativar sua conta Difrisul Select (
            {email}). Para completar a reativação da sua conta, clique no botão
            abaixo para confirmar que você deseja reativar o acesso aos nossos
            serviços.
          </Text>
          <Text style={text}>
          ...
          <Text style={smallText}>
            Se você não solicitou a reativação desta conta, por favor, contate
            nossa equipe de suporte imediatamente.
          </Text>
          <Text style={smallText}>
            Este link expirará em 15 minutos por motivos de segurança.
          </Text>
          <Text style={text}>
        ...
        <Section style={footer}>
          <Text style={footerText}>
            © {new Date().getFullYear()} Difrisul Ltda. Todos os direitos
            reservados.
          </Text>
          <Text style={social}>
            ...
            {" | "}
            <Link
              href={`https://api.whatsapp.com/send?phone=${process.env.NEXT_PUBLIC_COMMERCIAL_PHONE_FULL}`}
              style={socialLink}
            >
              Whatsapp
            </Link>
...
DifrisulChangeEmail.PreviewProps = {
  ...
  confirmationUrl:
    "https://difrisul-select.com.br/auth/confirm-email?token=abc123",
